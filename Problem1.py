...
# read test and train databse from pickle file
...
# Now apply linear regression on pickle file and show the efficiency

regr = LogisticRegression()

# values upon which test is going to occur
